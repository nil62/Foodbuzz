            ...
            <div class="Burger_President_here">
                    ...
                    <div class="room_thumb">
                        ...
                        <div class="room_heading d-flex justify-content-between align-items-center">
                            <div class="room_heading_inner">
                                <span>Best selling offer <br /> $8.5</span>
                                <h3>Chiken Burger </h3>
                            </div>                           
                        </div>
                    </div>
                ...
                <div class="single_Burger_President">
                    <div class="room_thumb">
                        ...
                        <div class="room_heading d-flex justify-content-between align-items-center">
                            <div class="room_heading_inner">
                                <span>Best selling offer <br /> $7</span>
                                <h3>Veg Burger </h3> 
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-5 col-lg-5 offset-lg-1 col-md-6">
                        <div class="about_info">
                            ...
                            <p style="text-align:justify;">When your goal is to change the way the country eats, you need all the help you can get. Food Buzz is an equal opportunity employer offering competitive salaries, comprehensive health benefits and equity opportunities.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-6 col-lg-4">
                            <div class="footer_widget text-center ">
                                ...
                                <p>Jalandhar - Delhi G.T. Road,<br> 
                                        5th floor rose Jalandar-144411 <br>
                        ...
                        <div class="col-xl-4 col-md-6 col-lg-4">
                            <div class="footer_widget text-center ">
                                ...
                                <p>Jalandhar - Delhi G.T. Road, <br> 
                                        5th floor green phagwara-144401 <br>
                                        <a href="#">food@gmail.com</a></p>
